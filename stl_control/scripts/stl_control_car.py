...
class stl_finish:
    def __init__(self):
        ...
        self.Pose = []
        self.current_pose       = rospy.Subscriber('/vrpn_client_node/rover_0/pose', ModelStates, self.callback_read_current_position, queue_size=1)
        self.navigation_input   = rospy.Publisher('/cmd_vel_0', Twist, queue_size=1)
    ...
    def get_pose(self,data):
        try:
            ...
            rospy.logwarn("[warning] The received message format is incorrect! ")
